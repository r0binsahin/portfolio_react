    ...
    <>
      <div id="start">
        ...
        <p>
          ...
          , where I am passionately exploring various tools and frameworks
          within frontend development. My journey began with studies at
          Medieinstitutet, and over the past year, my commitment to coding and
          problem-solving has only deepened.
        </p>
        <p>
